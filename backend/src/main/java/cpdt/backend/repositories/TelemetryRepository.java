...
/**
 * Repository for accessing historical telemetry measurements.
 *
 * <p>Provides database operations for storing and querying telemetry
 * records based on devices, process areas, and timestamps.
 *
